...
"""
csv file stored in the model reposotory contains integers will be used as an environment
...
As the wb file has 100 row thh number of the agents cant be more than 100 
